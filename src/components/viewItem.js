...
class viewItem extends Component {
    ...
    render() {
        return (
            <div>
            {
                this.props.loading?  <LoadingSpinner /> : <div className="row viewItem">
                            ...
                            <div className="wrapper row">
                                ...
                                <div className="preview col-md-7">
                                    ...
                                    <div className="preview-pic tab-content">
                                        <div className="tab-pane active" id="pic-1">
                                            {this.props.Item.map((itm, i) =>
                                                <img src={require(`../image/${itm.id}.png`)} key={i} alt="" />
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="details col-md-3">
                                    ...
                                    <div className="col-md-12 boderTop webInfo">
                                        ...
                                        {this.props.Item.map((itm, i) =>
                                            <div className="col-md-12 col-xs-4" key={i}>
                            ...
                            <div className="wrapper mInfo">
                                ...
                                <div className="">
                                    ...
                                    <div className="col-md-2 col-sm-6 col-xs-6">
                                        ...
                                        <div className="card" >
                                            <img className="card-img-top" src={require(`../image/1.png`)} alt="" />
                                    ...
                                    <div className="col-md-2 col-sm-6 col-xs-6">
                                        <div className="card" >
                                            <img className="card-img-top" src={require(`../image/2.png`)} alt="" />
                                            <div className="card-body">
                                    ...
                                    <div className="col-md-2 col-sm-6 col-xs-6">
                                        <div className="card" >
                                            <img className="card-img-top" src={require(`../image/3.png`)} alt="" />
                                            <div className="card-body">
                                    ...
                                    <div className="col-md-2 col-sm-6 col-xs-6">
                                        <div className="card" >
                                            <img className="card-img-top" src={require(`../image/4.png`)} alt="" />
                                            <div className="card-body">
                                                <p className="card-title">Nintendo Switch grey fullset warranty</p>
                                    ...
                                    <div className="col-md-2 col-sm-6 col-xs-6">
                                        <div className="card" >
                                            <img className="card-img-top" src={require(`../image/5.png`)} alt="" />
                                            <div className="card-body">
                                                <p className="card-title">Nintendo Switch grey fullset warranty</p>
                                    ...
                                    <div className="col-md-2 col-sm-6 col-xs-6">
                                        <div className="card" >
                                            <img className="card-img-top" src={require(`../image/6.png`)} alt="" />
                                            <div className="card-body">
                                                <p className="card-title">Nintendo Switch grey Joy-Con</p>
